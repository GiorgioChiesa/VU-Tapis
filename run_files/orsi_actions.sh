...
CONFIG_PATH="configs/Orsi/TAPIS/TAPIS_ACTIONS_ORSI.yaml"
OUTPUT_DIR="outputs/orsi/ACTIONS/$NAME/totale"
...
export PYTHONPATH=/workspaces/thesis_giorgiochiesa/src/TAPIS:$PYTHONPATH
...
ENDOVIS_DATASET.ORSI_ROOT_DIR $FRAME_DIR \
TEST.ENABLE False
