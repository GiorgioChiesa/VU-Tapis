...
VAL_FOLDS="['RARP06.csv','RARP11.csv','RARP17.csv','RARP22.csv','RARP28.csv','RARP33.csv','RARP38.csv','RARP45.csv','RARP65.csv']"
...
GT_VAL_FOLDS="['RARP06_coco.json','RARP11_coco.json','RARP17_coco.json','RARP22_coco.json','RARP28_coco.json','RARP33_coco.json','RARP38_coco.json','RARP45_coco.json','RARP65_coco.json']"
...
DATASET="orsi"
CONFIG_PATH="configs/Orsi/$ARCH/MEMORY_LONG.yaml"
...
COCO_ANN_PATH="/scratch/Video_Understanding/GraSP/TAPIS/data/"$DATASET"/annotations/grasp_long-term_val.json"
